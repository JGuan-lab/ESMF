...
analysis_prefix <- "MultiSourceReferenceIntegration_Mm_Hypothalamus_threshold200"
...
select_cellType <- c("Astrocytes", "Neurons", "Oligodendrocyteprogenitorcells", "Oligodendrocytes")
