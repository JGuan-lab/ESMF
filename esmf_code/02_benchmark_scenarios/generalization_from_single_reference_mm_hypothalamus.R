...
analysis_prefix <- "GeneralizationFromSingleReference_Mm_Hypothalamus_threshold200"
...
select_cellType <- c("Astrocytes", "Endothelialcells", "Microglia", "Neurons", "Oligodendrocytes")
