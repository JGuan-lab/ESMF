...
analysis_prefix <- "crossPlatformConsistency_Mm_Hypothalamus_threshold200"
...
selected_cell_types <- c("Astrocytes", "Neurons", "Oligodendrocyteprogenitorcells", "Oligodendrocytes")
