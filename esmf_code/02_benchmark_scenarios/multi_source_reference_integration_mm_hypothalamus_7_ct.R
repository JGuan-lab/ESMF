...
analysis_prefix <- "MultiSourceReferenceIntegration_Mm_Hypothalamus_7CT"
...
# ============================================================================
# This section loads and preprocesses four mouse brain single-cell RNA-seq datasets
# from the PanglaoDB database. The datasets share the same tissue (brain) and species
# (mouse) but are from different sequencing platforms (sim4 design).
# Training datasets: SRA481537_SRS1724938, SRA481537_SRS1724927, 
#                    SRA481537_SRS1724932, SRA481537_SRS1724941
# Test dataset: SRA694785_SRS3214440
# Selected cell types: Astrocytes, Neurons, Oligodendrocyteprogenitorcells, Oligodendrocytes
# ============================================================================

# ----------------------------------------------------------------------------
# Training Dataset 1: SRA481537_SRS1724938
# ----------------------------------------------------------------------------
set1 = "SRA481537_SRS1724938"
...
# ----------------------------------------------------------------------------
# Training Dataset 2: SRA481537_SRS1724927
# ----------------------------------------------------------------------------
set2 = "SRA481537_SRS1724927"
...
# ----------------------------------------------------------------------------
# Training Dataset 3: SRA481537_SRS1724932
# ----------------------------------------------------------------------------
set3 = "SRA481537_SRS1724932"
...
# ----------------------------------------------------------------------------
# Training Dataset 4: SRA481537_SRS1724941
# ----------------------------------------------------------------------------
set4 = "SRA481537_SRS1724941"
...
# ----------------------------------------------------------------------------
# Training Dataset 5: SRA694785_SRS3214438
# ----------------------------------------------------------------------------
set5 = "SRA694785_SRS3214438"
...
# ----------------------------------------------------------------------------
# For this brain tissue analysis, we focus on four major neural cell types:
# Astrocytes, Neurons, Oligodendrocyte progenitor cells, and Oligodendrocytes
select_cellType <- c("Astrocytes", "Endothelialcells", "Microglia", "Neurons",
                     "Oligodendrocyteprogenitorcells", "Oligodendrocytes", "Smoothmusclecells")
...
results <- read.table("/media/desk16/tjn050/LSC/LSC_deconvolution/LSC/results/sim4_SRA481537_SRS1724938_CIBERSORTx_Job109_Results.csv", 
                      header = TRUE, sep = ",")
...
# Vectorized (fast) ESMF deconvolution: mathematically equivalent to
# ESMF_deconvolution() but replaces the element-wise R loops with matrix
# operations, removing per-iteration message logging for speed.
