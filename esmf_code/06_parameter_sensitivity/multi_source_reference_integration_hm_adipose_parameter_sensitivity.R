...
analysis_prefix <- "Ablation_Study_MultiSourceReferenceIntegration_Hm_Adipose_ParameterSensitivity_v2"
ablation_version <- "v2"
...
# 仅追加到此副本脚本 Ablation_Study_MultiSourceReferenceIntegration_Hm_Adipose_ParameterSensitivity_v2.R。
